...
func ShareRobotChatHistoryHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.ShareRobotChatHistoryRequest
		if err := httpx.Parse(r, &req); err != nil {
			httpx.ErrorCtx(r.Context(), w, error.WithCause(error.InvalidParamsError, err.Error()))
			return
		}

		l := chat.NewShareRobotChatHistoryLogic(r.Context(), svcCtx)
		resp, err := l.ShareRobotChatHistory(&req)
		if err != nil {
