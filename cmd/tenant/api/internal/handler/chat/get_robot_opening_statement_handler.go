...
func GetRobotOpeningStatementHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.GetRobotOpeningStatementRequest
		if err := httpx.Parse(r, &req); err != nil {
			httpx.ErrorCtx(r.Context(), w, error.WithCause(error.InvalidParamsError, err.Error()))
			return
		}

		l := chat.NewGetRobotOpeningStatementLogic(r.Context(), svcCtx)
		resp, err := l.GetRobotOpeningStatement(&req)
		if err != nil {
