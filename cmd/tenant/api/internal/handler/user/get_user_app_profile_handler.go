...
func GetUserAppProfileHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.UserAppProfileRequest
		if err := httpx.Parse(r, &req); err != nil {
			httpx.ErrorCtx(r.Context(), w, error.WithCause(error.InvalidParamsError, err.Error()))
			return
		}

		l := user.NewGetUserAppProfileLogic(r.Context(), svcCtx)
		resp, err := l.GetUserAppProfile(&req)
		if err != nil {
