...
func SetUserAppProfileHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.SetUserAppProfileRequest
		if err := httpx.Parse(r, &req); err != nil {
			httpx.ErrorCtx(r.Context(), w, error.WithCause(error.InvalidParamsError, err.Error()))
			return
		}

		l := user.NewSetUserAppProfileLogic(r.Context(), svcCtx)
		err := l.SetUserAppProfile(&req)
		if err != nil {
