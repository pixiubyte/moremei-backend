...
const (
	...
	MsgTypeUnauthorized          MsgType = "unauthorized"
	MsgTypeUpdateAuthorized      MsgType = "updateauthorized"
	MsgTypeAuthorized            MsgType = "authorized"
	MsgTypeComponentVerifyTicket MsgType = "component_verify_ticket"
)
