...
require (
	...
	github.com/tencentcloud/tencentcloud-sdk-go/tencentcloud/captcha v1.0.1132
	...
	github.com/tencentyun/qcloud-cos-sts-sdk v0.0.0-20230907033301-e99498406670
